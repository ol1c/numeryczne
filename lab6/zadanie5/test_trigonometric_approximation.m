...
%       trygonometrycznej.
    ...
    xlabel('liczba harmonicznych zastosowanych w aproksymacji');
    ylabel('RMSE');
    title('Wartości RMSE w zależności od liczby harmonicznych');

    subplot(2,1,2);
    plot(x, y, 'k-', 'DisplayName', 'orginał');
    hold on;
    plot(x_fine, ya, 'r--', 'DisplayName', 'aprosymacja trygonemtryczna');
    hold off;
    xlabel('x');
